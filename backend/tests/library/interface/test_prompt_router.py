...
def test_create_prompt_registers_prompt_with_actor_and_format_metadata() -> None:
    """POST /prompts should create prompt records for humans and agents."""
    ...
    with override_library_provider("prompt_service", override_prompt_service()):
...
def test_create_prompt_rejects_duplicate_variable_names() -> None:
    """POST /prompts rejects templates with ambiguous duplicate variables."""
    item_repo = FakeItemRepository()
