...
```text
backend/.agents/rule/omx_type_enum_rule/type-development-rules.md
backend/.agents/rule/omx_type_enum_rule/pydantic/04-enums-literals-and-shared-types.md
```

### Pydantic / schema boundary rules

```text
backend/.agents/rule/omx_pydantic_rule/README.md
backend/.agents/rule/omx_pydantic_rule/01-configdict-and-model-shape.md
backend/.agents/rule/omx_pydantic_rule/02-strictness-defaults-and-nullability.md
backend/.agents/rule/omx_pydantic_rule/03-boundary-normalization.md
backend/.agents/rule/omx_pydantic_rule/schema-boundary-rules.md
```

### Folder / module cohesion rules

```text
backend/.agents/rule/omx_layout_rule/naming-and-folder-rules.md
backend/.agents/rule/omx_layout_rule/module-cohesion-rules.md
```
